    ...
    <table class="auto-style1" style="height: 649px">
        <tr>
            ...
            <td class="auto-style37">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button5" runat="server" OnClick="Button5_Click" Text="CLOSE" Visible="False" CssClass="btn btn-warning" />
            </td>
        </tr>
        <tr>
            <td class="auto-style27" >
                <asp:Panel ID="Panel3" runat="server" Height="589px" Width="461px">
                    <asp:Panel ID="Panel1" runat="server" BackColor="#CCFFFF" BorderColor="Black" Height="556px" style="margin-left: 15px; text-align: left; background-color: #F0F0F0;" Width="444px">
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <br />
                    ...
                    <cc1:RoundedCornersExtender ID="Panel1_RoundedCornersExtender" runat="server" BehaviorID="Panel1_RoundedCornersExtender" Radius="8" TargetControlID="Panel1" />
                </asp:Panel>
            </td>
            <td class="auto-style36">
                <asp:Panel ID="Panel4" runat="server" Height="579px">
                    <asp:Panel ID="Panel2" runat="server" BackColor="#66FF99" Height="553px" style="margin-left: 14px; background-color: #F0F0F0;" Width="318px">
                        <br />
                        ...
                        <br />
                        <br />
                        <asp:GridView ID="GridView1" runat="server" CellPadding="3" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="courseid" DataSourceID="SqlDataSource2" style="text-align: center; margin-left: 10px" Width="298px" AllowSorting="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CssClass="table table-bordered table-striped" Height="16px" PageSize="7">
                            <Columns>
                    ...
                    <cc1:RoundedCornersExtender ID="Panel2_RoundedCornersExtender" runat="server" BehaviorID="Panel2_RoundedCornersExtender" Radius="8" TargetControlID="Panel2" />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </asp:Panel>
            </td>
            <td class="auto-style38">
                <asp:Panel ID="Panel5" runat="server" Height="574px" style="margin-left: 5px" Width="460px">
                    <asp:Panel ID="Panel6" runat="server" BackColor="#FFFFCC" Height="550px" style="margin-left: 9px; background-color: #F0F0F0;" Visible="False" Width="446px">
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <br />
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:Button ID="Button6" runat="server" OnClick="Button6_Click" Text="DELETE" CssClass="btn btn-danger" />
                    </asp:Panel>
                    <cc1:RoundedCornersExtender ID="Panel6_RoundedCornersExtender" runat="server" BehaviorID="Panel6_RoundedCornersExtender" Radius="8" TargetControlID="Panel6" />
                </asp:Panel>
            </td>
        </tr>
    </table>
